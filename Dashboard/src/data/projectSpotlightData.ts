...
export const projectRegistry: Project[] = [
  {
    id: "horizon-cycle",
    name: "The Horizon Cycle",
    subtitle: "Book 1: First Light",
    category: "writing",
    status: "active",
    phase: "Drafting",
    priority: "high",
    coverLabel: "Horizon Cycle",
    coverKicker: "Book 1",
    accentColor: "sky",
    defaultAction: "start_focus_session",
    defaultActionLabel: "Start Writing Session",
    fallbackNextAction: "Write Chapter 4",
    ...
    linkedSources: {
      taskProjectIds: ["horizon-cycle"],
      calendarKeywords: ["Horizon Cycle", "Writing Block", "Chapter"],
      obsidianPaths: ["Writing/The Horizon Cycle"],
    },
    milestones: ["Outline Book 1", "Draft Chapter 4", "Finish Act 1"],
    summary: "Writing project spotlight is ready from structured project data. Notes and manuscript folders are still waiting for real connector validation.",
  ...
  },
  {
    id: "school-study",
    name: "School / Study",
    subtitle: "Coursework and deadlines",
    category: "school",
    status: "active",
    phase: "Coursework",
    priority: "critical",
    ...
    fallbackNextAction: "Review the next school deadline",
    contextLine: "Coursework and onboarding queue",
    progress: {
      type: "status",
      text: "In progress",
    },
    linkedSources: {
      taskProjectIds: ["school-study"],
      calendarKeywords: ["Study", "Class", "Course", "Lecture", "Canvas", "Assignment", "Quiz", "Exam", "Homework", "Orientation"],
      obsidianPaths: ["Calendar/Items", "School"],
    },
    milestones: ["Finish current coursework", "Plan next term", "Review deadlines", "Course planning"],
    summary: "School spotlight uses local RCF calendar deadlines first, then task and onboarding signals. External course-source checks are not live yet.",
    createdAt: "2026-07-01T00:00:00.000Z",
    updatedAt: "2026-07-04T00:00:00.000Z",
  },
  {
    ...
    defaultActionLabel: "Open Business Workspace",
    fallbackNextAction: "Draft newsletter pitch",
    contextLine: "Business workspace needs source links",
    progress: {
      type: "phase",
      text: "Current phase: First offer",
    },
    linkedSources: {
      taskProjectIds: ["consulting-business"],
      calendarKeywords: ["Business", "Client", "Consulting", "Outreach"],
      googleDriveFolderIds: ["business-drive-folder"],
    },
    milestones: ["Clarify first offer", "Draft newsletter pitch", "Build prospect list"],
    summary: "Business spotlight is seeded, but Drive, Sheets, and CRM-style data are still setup-needed.",
    createdAt: "2026-07-01T00:00:00.000Z",
    updatedAt: "2026-07-04T00:00:00.000Z",
  },
  {
  ...
  },
  {
    ...
    linkedSources: {
      ...
      calendarKeywords: ["Reminder", "Appointment", "Admin", "AHI"],
    },
...
function calendarItemMatchesProject(item: RcfCalendarItem, project: Project) {
  ...
  if (project.category === "school" && (itemCategory === "swc" || itemCategory === "ucsd")) return true;
...
function liveCalendarEventsForProject(project: Project, calendarItems: RcfCalendarItem[] = [], today = localIsoDate(new Date())) {
  ...
  return activeDatedItems(calendarItems)
    ...
    .map((item) => ({
      ...
      color: categoryKey(item) === "ucsd" ? "amber" : categoryKey(item) === "business" ? "green" : "violet",
