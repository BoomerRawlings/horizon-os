...
const CAPTURE_ACTIONS = {
  create_calendar_item: {
    ...
    queueLike: false,
    executor: "calendar",
    triageHint: "For create_calendar_item actions, fill payload date, time_start, time_end, importance, category, title, and action_needed using RCF rules. For homework, assignment, or Canvas deadlines with a date but no explicit time, use 23:58 local time; an explicit time always wins.",
  },
  save_note: {
    id: "save_note",
    ...
    queueLike: false,
    executor: "inbox_note",
    triageHint: "For save_note actions, the destination is Inbox. Put up to three exact existing-note targets in payload.connections only when they are genuinely useful; never invent a target.",
  },
  create_project: {
    id: "create_project",
    ...
    plan: "Horizon will stage this as a local project proposal note for review. Once you register the project, it will appear in Constellation beside any clearly named related project.",
    uiPlan: "Stages a project proposal for review. Registered projects appear in Constellation; no relationship is added unless one is clearly named.",
    permission: "Local markdown write",
    externalBoundary: "No external apps will be changed.",
    suggestable: true,
    queueLike: false,
  ...
  add_to_zotero: {
    ...
    plan: "Horizon will create one item in your Zotero library using your saved Zotero credentials, save a local capture link, and make it available in Research Desk and the compact Obsidian Shelf after the next library refresh.",
    uiPlan: "Creates one Zotero item, saves a local capture link, and makes it available in Research Desk and the compact Obsidian Shelf after refresh.",
  ...
  save_research: {
    ...
    plan: "Horizon will save a research note in Research Papers using the Author-YYYY convention, with DOI, date published, and a labeled Abstract or Summary. It appears on Research Desk and in the Obsidian paper directory. An exact DOI may complete missing bibliographic fields through Crossref.",
    uiPlan: "Saves a citable paper note in Research Papers, links the raw capture, and places it on Research Desk. An exact DOI can complete missing bibliographic fields through Crossref.",
    permission: "Local markdown write",
  ...
  save_research_idea: {
    ...
    plan: "Horizon will save this as a research idea note in Research Papers/Ideas and place it as a sticky note on Research Desk. It will not search or contact any external service.",
    uiPlan: "Saves this as a sticky note in Research Papers/Ideas and places it on Research Desk. Use a connected note when you want an explicit paper link.",
    permission: "Local markdown write",
    externalBoundary: "No external apps will be changed.",
    suggestable: true,
    queueLike: false,
